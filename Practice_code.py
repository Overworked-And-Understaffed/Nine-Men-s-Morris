...
class Board(object):
    ...
    def make_board(self):        
        # pygame.draw.rect(self.screen, BLACK, (725, 500, 50, 20))
        # help_button = menu_font.render("Help", True, (YELLOW))
        # self.screen.blit(help_button, [730,500])
        
        # pygame.draw.rect(self.screen, BLACK, (725, 400, 50, 20))
        # help_button = menu_font.render("Menu", True, (YELLOW))
        # self.screen.blit(help_button, [730, 400])
        
        pygame.draw.rect(self.screen, DUSTY_YELLOW, (100, 100, 600, 600))
        ...
        while i < 3:
           ...
           #setup circle placeholders
            pygame.draw.circle(self.screen, color, (x,x), 5)
            spots.append([x,x])

            pygame.draw.circle(self.screen, color, (y+x,y+x), 5)
            spots.append([y+x,y+x])

            pygame.draw.circle(self.screen, color, (y+x,x), 5)
            spots.append([y+x,x])

            pygame.draw.circle(self.screen, color, (x,y+x), 5)
            spots.append([x,y+x])

            pygame.draw.circle(self.screen, color, (x, 400), 5)
            spots.append([x, 400])

            pygame.draw.circle(self.screen, color, (y+x, 400), 5)
            spots.append([y+x, 400])

            pygame.draw.circle(self.screen, color, (400, x), 5)
            spots.append([400, x])

            pygame.draw.circle(self.screen, color, (400, x+y), 5)
            spots.append([400, x+y])
        
        
            #draws the long lines
            pygame.draw.line(self.screen, color, (x,x), (x,y+x), 5)
            pygame.draw.line(self.screen, color, (y+x,x), (y+x,y+x), 5)
            pygame.draw.line(self.screen, color, (x,x), (y+x,x), 5)
            pygame.draw.line(self.screen, color, (x,y+x), (y+x,y+x), 5)

            i=i+1
        
        #draws the short lines
        pygame.draw.line(self.screen, color, (board_coords2[0],400), (board_coords2[2],400), 5) #a4 - c4
        pygame.draw.line(self.screen, color, (board_coords2[0]+board_coords1[0],400), (board_coords2[2]+board_coords1[2],400), 5) #e4 - g4
        pygame.draw.line(self.screen, color, (400,board_coords2[0]), (400,board_coords2[2]), 5) #d7 - d5
        pygame.draw.line(self.screen, color, (400,board_coords2[0]+board_coords1[0]), (400,board_coords2[2]+board_coords1[2]), 5) #d3-d1
...
class Game(object):
    def __init__(self):
        ...
        self.screen = pygame.display.set_mode((self.WIDTH, self.HEIGHT)) #Window size
    ...
    def menu(self):
        ...
        menu.mainloop(Board.self.screen)
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    #condition for if spot is available
                        ...
                        pygame.draw.rect(self.screen, GRAY, (0,0,800,70)) #erase and replace exiting text of text
                        ...
                        #conditions to determine player turns and player count
                            ...
                            if turn % 2 == 0:                                
                                ...
                                # self.screen.blit(display_blacksTurn, [650,30])  

                            #WHITE PLACEMENT
                            else:
                                COLOR = WHITE
                                # display_whitesTurn = word_font.render ("Player A", True, (YELLOW))
                                # self.screen.blit(display_whitesTurn, [650,30])  
                            ...
                            if [x,y] != [0,0]: 
                                ...
                                if COLOR == BLACK:
                                    ...
                                    self.screen.blit(black_to_move, [200,50])   
                                    pygame.draw.circle(self.screen, BLACK, (x+5, y-3), 2)
                                    ...
                                    self.screen.blit(white_to_move, [200,50])
                                    pygame.draw.circle(self.screen, WHITE, (x+2, y-3), 2)
                ...
                #     pygame.draw.rect(self.screen, BLACK, (500,50,290,290))
                #     Help_instructions = menu_font.render("White goes first then Black", True, (YELLOW))
                #     self.screen.blit(Help_instructions, [505,70])
                                    
                # elif 725+20 < mouse_position[0] < 725 and 10+50 < mouse_position[1] < 10:
                #     pygame.draw.rect(self.screen, WHITE, (800,800,50,100))
...
class Game_menu(object):
    ...
    def game_menu(self):
        ...
        menu.add_title("Nine Men's Morris Game")
        menu.add_button('Play', Game.Main(self))
